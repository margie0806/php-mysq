...
<div class="container">
    <h1> Adicionar Generos </h1>
    <form method="POST" action="../php/db-genero.php">
        <div class="row">
        <div class="col-2">    
        <label for="tiquete">Genero</label>
        </div>
        <div class="col-4">
        <input type="text" class="form-control" placeholder="genero" name="genero" required="true"/>
        </div>
        </div>
