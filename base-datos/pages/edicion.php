...
<header>
        ...
        <nav class="nav-links">
            <ul>
                <li><a href="../index.php">Nacionalidad</a></li>
...
<div class="container">
    <h1> Adicionar Edicion </h1>
    <form method="POST" action="../php/db-edicion.php">
        <div class="row">
        <div class="col-2">    
        <label for="tiquete">edicion</label>
        </div>
        <div class="col-4">
        <input type="text" class="form-control" placeholder="edicion" name="edicion" required="true"/>
        </div>
        </div>
